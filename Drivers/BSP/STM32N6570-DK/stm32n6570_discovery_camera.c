...
__weak HAL_StatusTypeDef MX_DCMIPP_Init(DCMIPP_HandleTypeDef *hdcmipp)
{
  ...
  pPipeConf.PixelPipePitch  = 1200 ; /* Number of bytes */ // orig : 1600
  ...
  DonwsizeConf.HRatio      = 35389; // orig : 25656
  DonwsizeConf.VRatio      = 33177; // orig : 33161
  DonwsizeConf.HSize       = 600;   // orig : 800
  DonwsizeConf.VSize       = 480;
  DonwsizeConf.HDivFactor  = 237;   // orig : 316
  DonwsizeConf.VDivFactor  = 253;   // orig : 253
