...
:: Sign the app 
"%CUBEPROGRAMMER_TOOL_PATH%\STM32_SigningTool_CLI.exe" -s -bin "%BIN_DIR%STM32N6570-DK_Appli.bin" -nk -of 0x80000000 -t fsbl -o "%BIN_DIR%Project-trusted.bin" -hv 2.1 -dump "%BIN_DIR%Project-trusted.bin"
